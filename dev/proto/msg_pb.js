...
proto.org.kframework.kevm.extvm.Hello.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.org.kframework.kevm.extvm.EthereumConfig.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.org.kframework.kevm.extvm.IeleConfig.serializeBinaryToWriter
    );
  }
};
...
proto.org.kframework.kevm.extvm.Hello.prototype.getEthereumconfig = function() {
  return /** @type{proto.org.kframework.kevm.extvm.EthereumConfig} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.EthereumConfig, 2));
};
...
proto.org.kframework.kevm.extvm.Hello.prototype.getIeleconfig = function() {
  return /** @type{proto.org.kframework.kevm.extvm.IeleConfig} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.IeleConfig, 3));
};
...
proto.org.kframework.kevm.extvm.CallContext.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.org.kframework.kevm.extvm.BlockHeader.serializeBinaryToWriter
    );
  }
  f = this.getEthereumconfig();
  if (f != null) {
...
proto.org.kframework.kevm.extvm.CallContext.prototype.getBlockheader = function() {
  return /** @type{proto.org.kframework.kevm.extvm.BlockHeader} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.BlockHeader, 7));
};
...
proto.org.kframework.kevm.extvm.CallContext.prototype.getEthereumconfig = function() {
  return /** @type{proto.org.kframework.kevm.extvm.EthereumConfig} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.EthereumConfig, 8));
};
...
proto.org.kframework.kevm.extvm.CallContext.prototype.getIeleconfig = function() {
  return /** @type{proto.org.kframework.kevm.extvm.IeleConfig} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.IeleConfig, 9));
};
...
proto.org.kframework.kevm.extvm.EthereumConfig.prototype.getConstantinopleblocknumber_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getConstantinopleblocknumber()));
};
...
proto.org.kframework.kevm.extvm.CallResult.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    error: msg.getError(),
    modifiedaccountsList: jspb.Message.toObjectList(msg.getModifiedaccountsList(),
    proto.org.kframework.kevm.extvm.ModifiedAccount.toObject, includeInstance),
    deletedaccountsList: msg.getDeletedaccountsList_asB64(),
    touchedaccountsList: msg.getTouchedaccountsList_asB64(),
    logsList: jspb.Message.toObjectList(msg.getLogsList(),
    proto.org.kframework.kevm.extvm.LogEntry.toObject, includeInstance)
  };
...
proto.org.kframework.kevm.extvm.CallResult.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      6,
      f,
      proto.org.kframework.kevm.extvm.ModifiedAccount.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      9,
      f,
      proto.org.kframework.kevm.extvm.LogEntry.serializeBinaryToWriter
    );
  }
};
...
proto.org.kframework.kevm.extvm.CallResult.prototype.getModifiedaccountsList = function() {
  return /** @type{!Array.<!proto.org.kframework.kevm.extvm.ModifiedAccount>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.org.kframework.kevm.extvm.ModifiedAccount, 6));
};
...
proto.org.kframework.kevm.extvm.CallResult.prototype.getLogsList = function() {
  return /** @type{!Array.<!proto.org.kframework.kevm.extvm.LogEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.org.kframework.kevm.extvm.LogEntry, 9));
};
...
proto.org.kframework.kevm.extvm.ModifiedAccount.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    nonce: msg.getNonce_asB64(),
    balance: msg.getBalance_asB64(),
    storageupdatesList: jspb.Message.toObjectList(msg.getStorageupdatesList(),
    proto.org.kframework.kevm.extvm.StorageUpdate.toObject, includeInstance),
    code: msg.getCode_asB64()
  };
...
proto.org.kframework.kevm.extvm.ModifiedAccount.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.org.kframework.kevm.extvm.StorageUpdate.serializeBinaryToWriter
    );
  }
  f = this.getCode_asU8();
  if (f.length > 0) {
...
proto.org.kframework.kevm.extvm.ModifiedAccount.prototype.getStorageupdatesList = function() {
  return /** @type{!Array.<!proto.org.kframework.kevm.extvm.StorageUpdate>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.org.kframework.kevm.extvm.StorageUpdate, 4));
};
...
proto.org.kframework.kevm.extvm.VMQuery.prototype.serializeBinaryToWriter = function (writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.org.kframework.kevm.extvm.GetAccount.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.org.kframework.kevm.extvm.GetStorageData.serializeBinaryToWriter
    );
  }
  f = this.getGetcode();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.org.kframework.kevm.extvm.GetCode.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.org.kframework.kevm.extvm.GetBlockhash.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.org.kframework.kevm.extvm.CallResult.serializeBinaryToWriter
    );
  }
};
...
proto.org.kframework.kevm.extvm.VMQuery.prototype.getGetaccount = function() {
  return /** @type{proto.org.kframework.kevm.extvm.GetAccount} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.GetAccount, 1));
};
...
proto.org.kframework.kevm.extvm.VMQuery.prototype.getGetstoragedata = function() {
  return /** @type{proto.org.kframework.kevm.extvm.GetStorageData} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.GetStorageData, 2));
};
...
proto.org.kframework.kevm.extvm.VMQuery.prototype.getGetcode = function() {
  return /** @type{proto.org.kframework.kevm.extvm.GetCode} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.GetCode, 3));
};
...
proto.org.kframework.kevm.extvm.VMQuery.prototype.getGetblockhash = function() {
  return /** @type{proto.org.kframework.kevm.extvm.GetBlockhash} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.GetBlockhash, 4));
};
...
proto.org.kframework.kevm.extvm.VMQuery.prototype.getCallresult = function() {
  return /** @type{proto.org.kframework.kevm.extvm.CallResult} */ (
    jspb.Message.getWrapperField(this, proto.org.kframework.kevm.extvm.CallResult, 5));
};
