...
static block *dotList = (block *)((((uint64_t)getTagForSymbolName("Lbl'Stop'List'LBraQuotUndsCommUndsUnds'JSON'Unds'JSONs'Unds'JSON'Unds'JSONs'QuotRBraUnds'JSONs{}")) << 32) | 1);
...
static blockheader listHdr = getBlockHeaderForSymbol(getTagForSymbolName("Lbl'UndsCommUndsUnds'JSON'Unds'JSONs'Unds'JSON'Unds'JSONs{}"));
