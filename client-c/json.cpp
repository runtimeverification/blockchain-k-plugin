...
static block *dotList = (block *)((((uint64_t)getTagForSymbolName("Lbl'Stop'List'LBraQuotUndsCommUndsUnds'JSON'Unds'JSONList'Unds'JSON'Unds'JSONList'QuotRBraUnds'JSONList{}")) << 32) | 1);
static block *null = (block *)((((uint64_t)getTagForSymbolName("Lblnull'Unds'JSON'Unds'JSON{}")) << 32) | 1);
static block *undef = (block *)((((uint64_t)getTagForSymbolName("Lblundef'Unds'JSON-RPC'Unds'JSON{}")) << 32) | 1);
static blockheader listHdr = getBlockHeaderForSymbol(getTagForSymbolName("Lbl'UndsCommUndsUnds'JSON'Unds'JSONList'Unds'JSON'Unds'JSONList{}"));
static blockheader membHdr = getBlockHeaderForSymbol(getTagForSymbolName("Lbl'UndsColnUndsUnds'JSON'Unds'JSON'Unds'JSONKey'Unds'JSON{}"));
static blockheader objHdr = getBlockHeaderForSymbol(getTagForSymbolName("Lbl'LBraUndsRBraUnds'JSON'Unds'JSON'Unds'JSONList{}"));
static blockheader listWrapHdr = getBlockHeaderForSymbol(getTagForSymbolName("Lbl'LSqBUndsRSqBUnds'JSON'Unds'JSON'Unds'JSONList{}"));
